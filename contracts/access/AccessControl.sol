...
abstract contract AccessControl is Context, IAccessControl {
     ...
     */
    function hasRole(uint64 role, address account) public view virtual override returns (bool) {
        return _members[account] & role > 0;
    }
     ...
     */
    function getRoleAdmin(uint64 role) public view virtual override returns (uint64) {
     ...
     */
    function grantRole(uint64 role, address account) public virtual override onlyRole(getRoleAdmin(role)) {
     ...
     */
    function revokeRole(uint64 role, address account) public virtual override onlyRole(getRoleAdmin(role)) {
     ...
     * May emit a {RoleRevoked} event.
     */
    function renounceRole(uint64 role, address account) public virtual override {
